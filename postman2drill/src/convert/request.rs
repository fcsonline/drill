...
use crate::model::drill::{DrillAuth, DrillBody, DrillRequest, FormDataPart as DrillFormDataPart};
use crate::model::{Auth, Body, Header, Request, Url};
use crate::warnings::WarningCollector;
use anyhow::Result;
use std::collections::HashMap;

pub fn convert_request(req: Request, var_ctx: &VariableContext, inherited_auth: Option<&Auth>, warnings: &mut WarningCollector, location: &str) -> Result<DrillRequest> {
...
pub fn normalize_interpolations(s: &str) -> String {
  ...
  re.replace_all(s, |caps: &regex::Captures| format!("{{{{ {} }}}}", &caps[1])).to_string()
}
...
pub fn convert_auth(auth: Option<&Auth>, var_ctx: &VariableContext, warnings: &mut WarningCollector, location: &str) -> Result<Option<DrillAuth>> {
