...
pub fn execute(benchmark_path: &str, report_path_option: Option<&str>, relaxed_interpolations: bool, no_check_certificate: bool, maybe_cert_path: Option<&str>, maybe_cacert_path: Option<&str>, quiet: bool, nanosec: bool) -> BenchmarkResult {
  let config = Arc::new(Config::new(benchmark_path, relaxed_interpolations, no_check_certificate, maybe_cert_path, maybe_cacert_path, quiet, nanosec));
